...
"color: rgb(1, 78, 144);")
        ...
        self.Error_type.setGeometry(QtCore.QRect(0, 90, 521, 51))
        font = QtGui.QFont()
...
"background-color: rgb(1, 78, 144);")
        self.Error_type.setAlignment(QtCore.Qt.AlignCenter)
        self.Error_type.setObjectName("Error_type")
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(MainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 516, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Error_type.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:7pt; font-weight:400;\"><br/></span></p></body></html>"))
